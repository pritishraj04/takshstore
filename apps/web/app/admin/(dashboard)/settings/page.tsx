                        ...
                        <div className="group relative">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    placeholder="5000"
                                    className="w-full pl-8 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-colors text-sm"
                                />
                            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-pink-500 focus:ring-1 focus:ring-pink-500 transition-colors text-sm"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-3 py-2.5 bg-gray-50 border border-gray-200 rounded-lg outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors text-sm"
                            />
                        </div>
                    </div>
                </div>
