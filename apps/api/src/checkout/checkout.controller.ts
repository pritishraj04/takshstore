...
export class CheckoutController {
    ...
    async initiateCheckout(
        ...
        return this.checkoutService.initiateCheckout(userId, totalAmount, items, shippingAddress, developerNotes);
    }
    ...
    async verifyCheckout(
        ...
        return this.checkoutService.verifyCheckout(razorpayPaymentId, razorpayOrderId, razorpaySignature);
    }
